    ...
    links: [
      {
        ...
        subLinks: [
          {
            label: "Events",
            to: "/academic-events/events",
          },
          {
            label: "Event List",
            to: "/academic-events/event-list",
          },
        ],
      },
                ...
                <li key={label}>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                     ...
                     ${
                       isActive
                         ? "bg-white/20 text-[#ffd02c] shadow-md"
                         : "hover:bg-white/10 hover:text-[#ffd02c]"
                     }`
                    }
                    onClick={() => setSidebarOpen(false)}
                  >
